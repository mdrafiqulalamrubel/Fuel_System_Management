...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['record_payment'])) {
    ...
    $payment_type = $_POST['payment_type'] ?? 'regular'; // 'regular' or 'advance'
    ...
    try {
        ...
        if($payment_type == 'advance') {
            ...
            // =====================================================
            // REGULAR PAYMENT - Apply to credit sales
            // =====================================================
            ...
            foreach($credit_sales as $sale) {
                ...
                $applied_sales[] = ['invoice_no' => $sale['invoice_no'], 'amount' => $pay_amount];
            }
...
<body>
                        ...
                        <div class="card-body">
                            <form method="POST">
                                    ...
                                    <select name="customer_id" id="customer_id" class="form-control" required>
                                        ...
                                        <?php foreach($customers as $c): ?>
                                            <option value="<?php echo $c['id']; ?>" 
                                                ...
                                                - Due: <?php echo $currency; ?> <?php echo number_format($c['current_balance'], 2); ?> 
                                                | Advance: <?php echo $currency; ?> <?php echo number_format($c['advance_balance'], 2); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div id="customerInfo" style="display:none;" class="alert alert-info">
                                    ...
                                    <strong>Current Due:</strong> <?php echo $currency; ?> <span id="selected_due_amount">0.00</span><br>
                                    <strong>Advance Balance:</strong> <?php echo $currency; ?> <span id="selected_advance_amount">0.00</span>
                                </div>
                                ...
                                <table class="table table-bordered" id="paymentsTable">
                                    ...
                                    <tfoot class="table-light">
                                        <tr class="fw-bold">
                                            ...
                                            <td class="text-end text-success"><?php echo $currency; ?> <?php echo number_format(array_sum(array_column($recent_payments, 'amount')), 2); ?></td>
                                            <td colspan="2"></td>
                                        </tr>
                                    </tfoot>
                                </table>
    ...
    <script>
        ...
        document.getElementById('amount').addEventListener('input', function() {
            let type = document.getElementById('payment_type').value;
            let option = document.getElementById('customer_id').options[document.getElementById('customer_id').selectedIndex];
            let max = parseFloat(option.getAttribute('data-balance')) || 0;
            let amount = parseFloat(this.value) || 0;
            
            if(type == 'regular' && amount > max && max > 0) {
